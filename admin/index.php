...
<html lang="en">
	...
	<head>
		...
		<script src="assets/js/pace.min.j s"></script>
		<!-- Bootstrap CSS -->
	...
	<div class="col mx-auto">
		...
		<div class="card shadow-none">
					...
					<form action="" method="POST" class="row g-4">
						...
						<div class="col-12">
							...
							<div class="input-group" id="show_hide_password">
								<input type="password" class="form-control border-end-0" id="password" name="password" placeholder="Enter Password" required autocomplete="off" autofocus> <a href="javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
							</div>
						</div>
						<div class="col-md-6">
			...
			if(isset($_POST['loginBtn'])){
				...
				if($countUser == 0){
					echo '<div class="alert alert-danger">Sorry! No user found in our system. </div>';
				}
				else{
